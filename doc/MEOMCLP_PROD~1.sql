...
WHERE o.o_facility_alias_id  NOT IN ('012', '200', '400')
  AND O.created_dttm >= to_date('16-04-2017 00:00:00','DD-MM-YYYY HH24:MI:SS')
  AND O.created_dttm <= to_date('16-04-2017 23:59:59','DD-MM-YYYY HH24:MI:SS')
  --ORDER BY O.created_dttm DESC
  ;
